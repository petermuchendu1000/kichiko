...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Kichiko: East Africa Prediction Markets',
    template: '%s · Kichiko',
  },
  ...
  openGraph: {
    ...
    siteName: 'Kichiko',
    title: 'Kichiko: The clearest view of what happens next',
    ...
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Kichiko' }],
  },
  twitter: {
